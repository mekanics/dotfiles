...
defaults write NSGlobalDomain AppleLanguages -array "en" "de" "fr"
...
# Automatic spell checking as I type
...
defaults write com.apple.terminal "Default Window Settings" -string "Optometrist"
defaults write com.apple.terminal "Startup Window Settings" -string "Optometrist"
